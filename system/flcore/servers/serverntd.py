...
class FedNTD(object):
    def __init__(self, args, times, party2loaders, global_train_dl, test_dl):
        ...
        self.set_clients(clientNTD, party2loaders)
    ...
    def train(self):
        global_per_class_acc = torch.zeros(self.global_rounds, self.num_classes)
        local_per_class_acc = torch.zeros(self.num_clients, self.global_rounds, self.num_classes)
